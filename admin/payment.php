                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            ...
                                                            <tr>
                                                                <td><?php echo $row3['booking_id'] ?></td>
                                                                <td><?php echo $row3['txn_id'] ?></td>
                                                                <td><?php echo $row3['email'] ?></td>
                                                                <td>₹<?php echo $row3['amount'] ?></td>
                                                                <td><?php echo $row3['login_email'] ?></td>
                                                                <td><?php echo $row3['payment_date'] ?></td>
                                                                <td><?php echo $row3['payment_status'] ?></td>
                                                                <td>
                                                                <a href="ticket_detail.php?bid=<?php echo $row3['txn_id'];?>" title="View Details" class="btn btn-primary btn-sm"> View Details</a> 
                                                                </td>
                                                            </tr>
                                                    <?php $cnt++;
                                                        }
