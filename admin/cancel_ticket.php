            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select * from tblbookings where (BookingStatus='Accepted') and cancel_status = '1'");
$cnt=1;
...
<span class="badge bg-warning text-dark">Not Processed Yet</span>
 ...
 <th>
    <a href="cancel_booking_payment.php?id=<?php echo $result['BookingNumber'];?>" title="Cancel Booking" class="btn btn-danger btn-sm"> Cancel Booking</a>
 </th>
                  </tr>
         <?php $cnt++;} ?>
                </table>
