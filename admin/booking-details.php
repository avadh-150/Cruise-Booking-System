...
$query=mysqli_query($con,"select tblbookings.*, tblboat.* from tblbookings join tblboat on tblboat.ID=tblbookings.BoatID  where tblbookings.ID='$bid'");
$cnt=1;
...
?>
       ...
       <tr>
                  ...
                  <tr>
                   ...
                   <td><?php echo $result['Source']?> To </td>
