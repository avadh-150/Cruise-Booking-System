...
?>
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="dashboard.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Cruise Booking System | Admin </span>
      </a>
      <div class="sidebar">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                ...
                <li class="nav-item">
                  <a href="all_boat.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p> All</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="boat-history.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p> cruise_history</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                ...
                <li class="nav-item">
                  <a href="cancel_ticket.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Cancel Booking</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                <li class="nav-item">
                  <a href="add-blogs.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add</p>
                  </a>
                </li>
            ...
            <!--supports && request--->
            <li class="nav-item">
              <a href="user_query.php" class="nav-link">
                <i class="nav-icon fas fa-file"></i>
                <p>
                Supports && Request
                </p>
 ...
 <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                <li class="nav-item">
                  <a href="add-teams.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add</p>
                  </a>
                </li>
