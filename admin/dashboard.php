        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <?php
              $query12 = mysqli_query($con, "SELECT SUM(amount) AS total_earning FROM tblpayment");
              $row = mysqli_fetch_assoc($query12);
              $totalEarning = $row['total_earning'] ?? 0; // Default to 0 if no rows are found
              ?>
